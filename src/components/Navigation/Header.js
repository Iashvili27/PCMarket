      ...
      <div className="bg-white flex h-[100px]  items-center justify-evenly border-b-2  w-full">
        ...
        <div className={searchResponsive ? "md:hidden block" : "hidden"}>
          <button
            ...
            className="md:hidden p-2.5 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  "
          >
            <svg
              className="w-5 h-5"
              fill="none"
